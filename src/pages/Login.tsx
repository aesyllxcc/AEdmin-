...
import { SUPER_ADMIN_EMAIL } from '@/utils/workspaceManager';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] flex flex-col justify-between p-4 sm:p-8 font-sans antialiased text-[#18191D]">
        ...
        <div className="bg-white p-8 sm:p-10 rounded-[32px] border border-[#ECE6DD] shadow-xl space-y-6 animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="space-y-1.5 text-center">
            ...
            <p className="text-xs text-stone-500">
              Enter your credentials to access your private isolated workspace.
            </p>
          </div>
          ...
          {/* Prospective User Direct Contact Callout */}
          <div className="p-5 bg-[#FAF8F5] rounded-2xl border border-[#ECE6DD] text-center space-y-2.5">
            <p className="text-xs font-semibold text-stone-700">
              Need your own isolated workspace?
            </p>
            <p className="text-[11px] text-stone-500 leading-relaxed">
              Workspaces are provisioned directly by the Platform Owner. Contact <strong>hello.aespace@gmail.com</strong> directly to obtain private access credentials.
            </p>
            <button
              type="button"
              onClick={() => setIsAccessModalOpen(true)}
              className="text-xs font-black text-[#18191D] hover:underline flex items-center justify-center gap-1 mx-auto pt-1 cursor-pointer"
            >
      ...
      {/* Request Access & Direct Contact Modal */}
      <RequestAccessModal
